...
class AIService:
    ...
    def __init__(self):
        ...
        self.llm_provider = os.getenv("DRAFT_LLM_PROVIDER", "anthropic")
        self.model = os.getenv("DRAFT_MODEL", "claude-3-5-sonnet-20241022")

        # Get API keys
        anthropic_key = os.getenv("ANTHROPIC_API_KEY")
        openai_key = os.getenv("OPENAI_API_KEY")

        if self.llm_provider == "anthropic" and anthropic_key:
