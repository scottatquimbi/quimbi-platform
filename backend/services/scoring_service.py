...
class ScoringService:
    ...
    def __init__(self):
        ...
        self.churn_weight = float(os.getenv("SCORING_CHURN_WEIGHT", "3.0"))
        self.value_weight = float(os.getenv("SCORING_VALUE_WEIGHT", "2.0"))
        self.urgency_weight = float(os.getenv("SCORING_URGENCY_WEIGHT", "1.5"))
        self.topic_alert_boost = float(os.getenv("TOPIC_ALERT_BOOST", "5.0"))
